  ...
  async function sendMessage() {
    ...
    try {
      const res = await fetch(
        "https://healthcare-support-app-moys.onrender.com/chat",
        {
          method: "POST",
  ...
  return (
    <div className="page">
      <header className="header">
        <div>
          ...
          <p className="subtitle">
            Ask a health question and get general guidance.
          </p>
        </div>
      </header>
      ...
      <footer className="footer">
        <div>
          If symptoms are severe or you feel unsafe, contact local emergency
